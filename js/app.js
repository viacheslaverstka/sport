(() => {
    ...
    function initSliders() {
        if (document.querySelector(".signboard")) new core(".signboard__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".product-slider__sub-slider")) var subSwiper = new core(".product-slider__sub-slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".product-slider__slider")) new core(".product-slider__slider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    sideMenuButton.addEventListener("click", (function(e) {
        sideMenuButton.classList.toggle("open");
        _slideToggle(document.querySelector(".side-menu__list"));
    }));
    if (document.querySelector(".catalog")) _slideToggle(document.querySelector(".side-menu__list"));
    const buttonchik = document.querySelectorAll(".side-menu__buttonchik");
    buttonchik.forEach(((element, index, array) => {
        _slideUp(element.parentElement.nextElementSibling);
        element.addEventListener("click", (function(event) {
            event.target.classList.toggle("open");
            _slideToggle(event.target.parentElement.nextElementSibling);
        }));
    }));
    if (document.querySelector(".seach-form__select-btn")) {
        _slideUp(document.querySelector(".seach-form__select"));
        const seachSelect = document.querySelector(".seach-form__select-btn");
        seachSelect.addEventListener("click", (function(e) {
            seachSelect.classList.toggle("open");
            _slideToggle(document.querySelector(".seach-form__select"));
        }));
        function counterSelect() {
            let i = 0;
            document.querySelectorAll(".seach-form__labe-checkbox input").forEach(((element, index, array) => {
                if (element.checked) i++;
            }));
            return i;
        }
        const SeachFormCheckbox = document.querySelectorAll(".seach-form__labe-checkbox");
        const SeachFormCounter = document.querySelector(".seach-form__counter");
        SeachFormCheckbox.forEach(((element, index, array) => {
            element.addEventListener("click", (function(e) {
                let n = counterSelect();
                if (n) SeachFormCounter.innerHTML = `Выбрано: ${n}`; else SeachFormCounter.innerHTML = `Везде`;
            }));
        }));
    }
    if (document.querySelector(".noUislider")) {
        noUiSlider.create(document.querySelector(".noUislider"), {
            start: [ 5e4, 15e4 ],
            connect: true,
            range: {
                min: 0,
        ...
        const inputNumberStart = document.querySelector(".spollers__start");
        const inputNumberEnd = document.querySelector(".spollers__end");
        inputNumberStart.addEventListener("change", (function(e) {
            document.querySelector(".noUislider").noUiSlider.set([ this.value, null ]);
        }));
        inputNumberEnd.addEventListener("change", (function(e) {
            document.querySelector(".noUislider").noUiSlider.set([ null, this.value ]);
        }));
    }
